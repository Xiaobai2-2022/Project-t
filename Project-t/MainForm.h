...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			for (int i = 0; i < num_col_s; i++) {
				for (int j = 0; j < num_row_s; j++) {
					this->labels_left[to_row_major(i, j, num_row_s)]->Location = System::Drawing::Point(size_border + i * size_disp_block, size_border + j * size_disp_block);	// calculate the location for the block
					this->labels_left[to_row_major(i, j, num_row_s)]->Name = L"label" + i;
			...
			for (int i = 0; i < num_col_s; i++) {
				for (int j = 0; j < num_row_s; j++) {
					this->labels_right_main[to_row_major(i, j, num_row_s)]->Location = System::Drawing::Point(size_form_x - right_offset + size_border * 3 + i * size_disp_block, size_border + j * size_disp_block);	// calculate the location for the block
					this->labels_right_main[to_row_major(i, j, num_row_s)]->Name = L"label" + i;
			...
			for (int i = 0; i < num_col_s; i++) {
				for (int j = 0; j < num_row_s; j++) {
					this->labels_right_2nd[to_row_major(i, j, num_row_s)]->Location = System::Drawing::Point(size_form_x - right_offset_s + size_border * 3 + i * size_small_block, size_border + j * size_small_block + 4 * size_disp_block + size_border);	// calculate the location for the block
					this->labels_right_2nd[to_row_major(i, j, num_row_s)]->Name = L"label" + i;
			...
			for (int i = 0; i < num_col_s; i++) {
				for (int j = 0; j < num_row_s; j++) {
					this->labels_right_3rd[to_row_major(i, j, num_row_s)]->Location = System::Drawing::Point(size_form_x - right_offset_s + size_border * 3 + i * size_small_block, size_border + j * size_small_block + 4 * size_disp_block + 3 * size_small_block + 2 * size_border);	// calculate the location for the block
					this->labels_right_3rd[to_row_major(i, j, num_row_s)]->Name = L"label" + i;
			...
			for (int i = 0; i < num_col_s; i++) {
				for (int j = 0; j < num_row_s; j++) {
					this->labels_right_4th[to_row_major(i, j, num_row_s)]->Location = System::Drawing::Point(size_form_x - right_offset_s + size_border * 3 + i * size_small_block, size_border + j * size_small_block + 4 * size_disp_block + 6 * size_small_block + 3 * size_border);	// calculate the location for the block
					this->labels_right_4th[to_row_major(i, j, num_row_s)]->Name = L"label" + i;
			...
			for (int i = 0; i < num_col_s; i++) {
				for (int j = 0; j < num_row_s; j++) {
					this->labels_right_5th[to_row_major(i, j, num_row_s)]->Location = System::Drawing::Point(size_form_x - right_offset_s + size_border * 3 + i * size_small_block, size_border + j * size_small_block + 4 * size_disp_block + 9 * size_small_block + 4 * size_border);	// calculate the location for the block
					this->labels_right_5th[to_row_major(i, j, num_row_s)]->Name = L"label" + i;
			...
			this->label_left_score->Name = L"label_score";
			...
			this->label_left_score_disp->Name = L"label_score_disp";
			...
			this->label_right_next->Name = L"label_next";
			...
			this->label_right_next_2nd->Name = L"label_2nd";
			...
			this->label_right_next_3rd->Name = L"label_3rd";
			...
			this->label_right_next_4th->Name = L"label_4th";
			...
			this->label_right_next_5th->Name = L"label_5th";
